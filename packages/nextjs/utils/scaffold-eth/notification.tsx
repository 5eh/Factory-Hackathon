...
const Notification = ({
  ...
  return toast.custom(
    t => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm border border-black dark:border-white shadow-primary bg-primary/20 shadow-2xl backdrop-blur-lg p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${
